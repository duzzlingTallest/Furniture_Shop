        ...
        <div className="">
          <div className=" w-[300px] rounded-md border">
            <img
              ...
              alt="Laptop"
              className="h-[200px] p-[10px] w-full rounded-full"
            />
            <div className="p-4">
              <div className="h-56 ">
                <h1 className="mt-5  text-6xl font-semibold ">Name : {user?.name}</h1>
                <h6 className="mt-5  font-medium">Email : {user?.email}</h6>
                <h6 className="mt-5  font-medium">Number : {user?.number}</h6>
                <p className="mt-5 ml-[43px] text-sm text-gray-600"></p>

                <button
                  onClick={() => logoutHandler()}
                  className="ml-[60px] justify-center transition ease-in-out delay-150 bg-red-500 hover:-translate-y-1 hover:scale-110 hover:bg-red-500 duration-300 text-white"
                >
                  Logout
                </button>
              </div>

              <div className="mt-4 flex flex-wrap ml-[95px]">
